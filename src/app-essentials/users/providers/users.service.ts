...
import { CardServices } from '../../../app-features/notecards/providers/notecards.service';
...
import { HashingProvider } from '../../../app-security/auth/providers/hashing.provider';
...
export class UsersService {
  ...
  async findUserByEmailPassword(userEmail: string): Promise<User> {
    let user: User;
    try {
      user = await this.usersRepository.findOneBy({
        userEmail: userEmail,
  ...
  // todo: upload AWS S3 to upload user avatars
