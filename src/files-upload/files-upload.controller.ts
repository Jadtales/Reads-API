import {
    ...
    Param, ParseFilePipe,
    ParseFilePipeBuilder, ParseUUIDPipe,
    Post,
    UploadedFile,
    UseInterceptors
} from '@nestjs/common';
...
export class FilesUploadController {
    ...
    uploadUserKindleFiles(
        ...
        @UploadedFile(
            new ParseFilePipeBuilder()
                ...
                .addMaxSizeValidator({maxSize: 5 * 1024 * 1024, message: 'File must be less than 5MB'})
    ...
    uploadUserProfilePicture(
        ...
        return this.userProfilePictureUploadService.uploadUserProfilePicture(userId, img)
    }
