...
export default function SubModalComponent(): ReactElement | null {
        ...
        <button onClick={handleDialogOpening} className={'getPremiumButton'}>Get Premium</button>
            ...
            <dialog className="subscriptionModalContainer" ref={modalRef} >
                <div className="subModal_topLayer">
                    ...
                    <Image id="closingModalIcon" src={ClosingIcon} alt="closeSubModal"
                ...
                <div className="monthlyAndAnnuallyButtons">
                    ...
                    <button onClick={() => changeBillingMethod('annually')}
                            className={userBillingMethod === "annually" ? 'userBillingMethodChoice' : ''}>Annually
                        Billing
                    </button>
                </div>
