import NotificationsComponent from "@/app/compos/navbar/notifications_reportBugs_Component/notificationsComponents/NotificationsComponent";
...
export default function NotificationsDurationFiltering({ NotificationsData }: ComponentProps) {
    const [filterDuration, setFilterDuration] = useState<string>("Today");
    ...
    return (
        <Fragment>
            <div className="duration">
                <button onClick={() => filterNotifications("Today")}>Today</button>
                <button onClick={() => filterNotifications("Last week")}>Last week</button>
                <button onClick={() => filterNotifications("Last two weeks")}>Last two weeks</button>
            </div>
