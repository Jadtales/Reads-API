...
export default function ImportExternal_NotecardComponents(): ReactElement {
    return <div className="notesCreationFromExternalSources-layer">
        ...
        <div className="importButtons">
            <button>Import highlights from your Kindle <Image src={KindleDeviceIcon} alt="kindle"/></button>
            <button>Import savings from <Image src={Twitter_X_Icon} alt="twitter"/></button>
            <button>Import your highlights from Readwise <Image src={Twitter_X_Icon} alt="twitter"/></button>
        </div>
    </div>
}